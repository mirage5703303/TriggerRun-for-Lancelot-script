...
namespace TriggeRun {
    ...
    public class FPSCamera : MonoBehaviour {
        ...
        private void Start() {
            ...
            rotationCharacter = playerCharacterRigidbody.transform.localRotation;
            //Cache the camera's initial rotation.
            rotationCamera = transform.localRotation;
        }
        private void LateUpdate() {
            //Frame Input. The Input to add this frame!
            Vector2 frameInput = new Vector2(Input.GetAxis("Mouse X"), Input.GetAxis("Mouse Y"));//playerCharacter.IsCursorLocked() ? playerCharacter.GetInputLook() : default;
            //Sensitivity.
